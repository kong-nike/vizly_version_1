 ...
 * Features: Form validation, password visibility toggle, dark mode, social login options
 */
        ...
        <div className={styles.card}>
          ...
          <div className={styles.header}>
            <div className={styles.logoContainer}>
              <img src={vizlyLogo} alt="Vizly" className={styles.logo} />
            </div>
            <h1 className={styles.title}>Log In</h1>
            <p className={styles.subtitle}>Log in to your Vizly account</p>
          </div>
